...
def main(input_file, output_file, ref_dir="./Ref"):
    ...
    scaler_params = pd.read_csv(os.path.join(ref_dir, "scaler_parameters.tsv"), sep="\t")
    ...
    encoder = load_model(os.path.join(ref_dir, "encoder_model.h5"))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--ref-dir", default="./Ref", help="Reference directory containing scaler_parameters.tsv and encoder_model.h5")
    args = parser.parse_args()

    main(args.input_file, args.output_file, args.ref_dir)
